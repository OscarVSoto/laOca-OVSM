...
function Normal(){
	...
	this.cae=function(ficha){
		...
		console.log("Has caido en casilla normal.");
		ficha.cambiarTurno();
	}
}
...
function Muerte(salidaNormal){
	...
	this.cae=function(ficha){
		...
		console.log("Mala suerte, a volver a empezar.");
...
function Posada(){
	...
	this.castigo=1;
	this.cae=function(ficha){
		console.log("Has caído en la posada, un turno sin tirar.");
...
this.titulo="Pozo";
	this.castigo=2;
	this.cae=function(ficha){
		console.log("Has caído en el pozo, dos turnos sin tirar.");
		ficha.jugador.castigo=this.castigo;
		ficha.cambiarTurno();
	}
}
...
function Laberinto(){
	...
	this.castigo=3;
	this.cae=function(ficha){
		console.log("Has caído en el laberinto, tres turno sin tirar.");
		ficha.jugador.castigo=this.castigo;
		ficha.cambiarTurno();
	}
}
...
function Carcel(){
	...
	this.castigo=4;
	this.cae=function(ficha){
		console.log("Has caído en la carcel, cuatro turno sin tirar.");
		ficha.jugador.castigo=this.castigo;
		ficha.cambiarTurno();
	}
}
...
function Final(){
	this.titulo="Meta";
	this.cae=function(ficha){
		console.log("El jugador "+ficha.jugador.nombre+" ha ganado la partida.");
